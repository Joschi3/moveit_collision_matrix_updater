 ...
 */
moveit_setup::DataWarehousePtr initializeDataWarehouse(
 ...
 */
moveit_setup::srdf_setup::DefaultCollisions * initializeCollisionUpdater(
  const moveit_setup::DataWarehousePtr & data_warehouse);
...
void updateCollisionMatrix(
  moveit_setup::srdf_setup::DefaultCollisions * collision_updater,
